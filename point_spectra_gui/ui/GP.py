...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.numOfComponentsLineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.numOfComponentsLineEdit.setObjectName("numOfComponentsLineEdit")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.numOfComponentsLineEdit)
