...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout.addWidget(self.formGroupBox_CV)
        ...
        self.crossValidateCheckBox.toggled['bool'].connect(self.formGroupBox_CV.setVisible)
        self.crossValidateCheckBox.toggled['bool'].connect(self.formGroupBox.setHidden)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(("Form"))
        self.formGroupBox_CV.setTitle(("Ridge CV"))
        ...
        self.formGroupBox.setTitle(("Ridge"))
