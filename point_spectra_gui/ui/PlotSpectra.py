...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.chooseDataListView = QtWidgets.QListView(self.groupBox)
        self.chooseDataListView.setObjectName("chooseDataListView")
        self.gridLayout_2.addWidget(self.chooseDataListView, 0, 1, 1, 2)
