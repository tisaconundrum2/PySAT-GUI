...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.epsLabel)
        self.epsDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.formGroupBox)
        self.epsDoubleSpinBox.setObjectName("epsDoubleSpinBox")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.epsDoubleSpinBox)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.max_iterLabel)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.max_iterSpinBox)
        self.cvLabel = QtWidgets.QLabel(self.formGroupBox)
        self.cvLabel.setObjectName("cvLabel")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.cvLabel)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.cvSpinBox)
        self.max_n_alphasLabel = QtWidgets.QLabel(self.formGroupBox)
        self.max_n_alphasLabel.setObjectName("max_n_alphasLabel")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.max_n_alphasLabel)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.max_n_alphasSpinBox)
        self.n_jobsLabel = QtWidgets.QLabel(self.formGroupBox)
        self.n_jobsLabel.setObjectName("n_jobsLabel")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.n_jobsLabel)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.n_jobsSpinBox)
        self.cVLabel = QtWidgets.QLabel(self.formGroupBox)
        self.cVLabel.setObjectName("cVLabel")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.cVLabel)
        self.cVCheckBox = QtWidgets.QCheckBox(self.formGroupBox)
        self.cVCheckBox.setObjectName("cVCheckBox")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.cVCheckBox)
