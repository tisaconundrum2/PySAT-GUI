...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.xMinSpinBox = QtWidgets.QSpinBox(self.groupBox)
        self.xMinSpinBox.setObjectName("xMinSpinBox")
        self.xLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.xMinSpinBox)
        self.xMaxSpinBox = QtWidgets.QSpinBox(self.groupBox)
        self.xMaxSpinBox.setObjectName("xMaxSpinBox")
        self.xLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.xMaxSpinBox)
        ...
        self.yMinSpinBox = QtWidgets.QSpinBox(self.groupBox)
        self.yMinSpinBox.setObjectName("yMinSpinBox")
        self.yLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.yMinSpinBox)
        self.yMaxSpinBox = QtWidgets.QSpinBox(self.groupBox)
        self.yMaxSpinBox.setObjectName("yMaxSpinBox")
        self.yLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.yMaxSpinBox)
        ...
        Form.setTabOrder(self.xTitleLineEdit, self.xMinSpinBox)
        Form.setTabOrder(self.xMinSpinBox, self.xMaxSpinBox)
        Form.setTabOrder(self.xMaxSpinBox, self.chooseYVariableComboBox)
        Form.setTabOrder(self.chooseYVariableComboBox, self.yTitleLineEdit)
        Form.setTabOrder(self.yTitleLineEdit, self.yMinSpinBox)
        Form.setTabOrder(self.yMinSpinBox, self.yMaxSpinBox)
        Form.setTabOrder(self.yMaxSpinBox, self.colorComboBox)
