...
# Form implementation generated from reading functions file 'C:\Users\nfinch\Desktop\GitHub\PySAT_Point_Spectra_GUI\point_spectra_gui\functions\\UI Files\OMP.functions'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.optimizeWCrossValidationLabel.setText(
            _translate("Form", "Optimize w/ Cross Validation (Ignores # of Coeffs)"))
