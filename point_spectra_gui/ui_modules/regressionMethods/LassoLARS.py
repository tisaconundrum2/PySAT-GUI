...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.alphaDoubleSpinBox.setMaximum(999.0)
        ...
        self.maxNumOfIterationsSpinBox.setMaximum(9999)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.forcePositiveCoefficientsCheckBox)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.optimizeWCrossValidationLabel)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.optimizeWCrossValidationCheckBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.optimizeWCrossValidationLabel.setText(_translate("Form", "Optimize w/ Cross Validation (Ignores Alpha)"))
