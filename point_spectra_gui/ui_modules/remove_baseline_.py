...
;         2: spline interpolation'''
    ...
    def baseline_ui(self):
        ...
        self.remove_baseline.setObjectName(("remove_baseline"))
        self.baseline_vlayout = QtWidgets.QVBoxLayout(self.remove_baseline)
        self.baseline_vlayout.setObjectName(("baseline_vlayout"))
        # choose data
        self.baseline_choosedata_hlayout = QtWidgets.QHBoxLayout()
        self.baseline_choosedata_hlayout.setObjectName(("baseline_choosedata_hlayout"))
        self.remove_baseline_choosedata_label = QtWidgets.QLabel(self.remove_baseline)
        self.remove_baseline_choosedata_label.setObjectName(("remove_baseline_choosedata_label"))
        ...
        self.baseline_choosealg_hlayout.setObjectName(("baseline_choosealg_hlayout"))
