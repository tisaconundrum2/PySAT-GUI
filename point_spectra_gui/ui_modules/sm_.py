...
class sm_:
    ...
    def sm_ui(self):
        ...
        self.choosemodel.setObjectName("self.choosemodel")
        ...
        self.low_model_max.setObjectName("self.low_model_max")
        ...
        self.high_model_label.setObjectName("self.high_model_label")
        self.choose_high_model = make_combobox(modelchoices)
        self.high_model_hlayout.addWidget(self.choose_high_model)
        self.choose_high_model.setObjectName("self.choose_high_model")
        ...
        self.high_model_min_label.setObjectName("self.high_model_min_label")
        ...
        self.high_model_min.setObjectName("self.high_model_min")
        ...
        self.add_submodel_button.setObjectName("self.add_submodel_button")
        ...
        self.delete_submodel_button.setObjectName("self.delete_submodel_button")
        self.optimize_checkbox = QtWidgets.QCheckBox(self.submodel_predict)
        self.add_delete_hlayout.addWidget(self.optimize_checkbox)
        self.optimize_checkbox.setObjectName("self.optimize_checkbox")
        ...
        self.choosedata_predict_label.setObjectName("self.choosedata_predict_label")
        self.choosedata_predict = make_combobox(datachoices)
        self.predictdata_vlayout.addWidget(self.choosedata_predict)
        self.choosedata_predict.setObjectName("self.choosedata_predict")
