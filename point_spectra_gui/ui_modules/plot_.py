...
class plot_:
    ...
    def plot_ui(self):
        ...
        self.plot.setTitle(("MainWindow", "Scatter Plot", None))
        self.scatter_choosedata_label.setText(("MainWindow", "Choose data: ", None))
        self.figname_label.setText(("MainWindow", "Figure name:", None))
        self.plot_title_label.setText(("MainWindow", "Plot Title: ", None))
        self.scatter_choosex_label.setText(("MainWindow", "Choose X variable:", None))
        self.xtitle_label.setText(("MainWindow", "X title:", None))
        self.xmin_labe.setText(("MainWindow", "X min:", None))
        self.xmax_label.setText(("MainWindow", "X max:", None))
        self.ytitle_label.setText(("MainWindow", "Y title:", None))
        self.ymin_label.setText(("MainWindow", "Y min:", None))
        self.ymax_label.setText(("MainWindow", "Y max:", None))
        self.scatter_choosey_label.setText(("MainWindow", "Choose Y variable:", None))
        self.legend_label.setText(("MainWindow", "Legend Label: ", None))
        self.onetoone.setText(("MainWindow", "One to One", None))
        self.color_label.setText(("MainWindow", "Color:", None))
        ...
        self.line_label.setText(("MainWindow", "Line:", None))
        ...
        self.marker_label.setText(("MainWindow", "Marker:", None))
        ...
        self.file_label.setText(("MainWindow", "Plot Filename:", None))
        self.alpha_label.setText(("MainWindow", "Alpha:", None))

        self.plot.setTitle(("plot", "Plot", None))
