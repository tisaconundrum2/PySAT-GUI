...
class regression_predict_:
    ...
    def regression_ui(self):
        ...
        self.regression_predict_vlayout = QtGui.QVBoxLayout()
        ...
        self.regression_predict_choosedata_hlayout.addWidget(self.regression_choosedata_label)
        ...
        self.regression_predict_choosedata.setObjectName(_fromUtf8("regression_choosedata"))
        ...
        self.regression_predict_vlayout.addLayout(self.regression_choosedata_hlayout)
        ...
        self.regression_predict_choosemodel_hlayout.addWidget(self.regression_choosemodel_label)
        self.regression_predict_choosemodel = QtGui.QComboBox(self.regression_predict)
        self.regression_predict_choosemodel.setIconSize(QtCore.QSize(50, 20))
        self.regression_predict_choosemodel.setObjectName(_fromUtf8("regression_predict_choosemodel"))
        self.regression_predict_choosemodel.addItem(_fromUtf8(""))
        modelchoices = self.pysat_fun.modelkeys
        if modelchoices == []:
            error_print('No model has been trained')
            datachoices = ['No model has been trained!']
        self.regression_choosedata = make_combobox(modelchoices)
        ...
        self.regression_predict_choosemodel_hlayout.addWidget(self.regression_choosemodel)
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.regression_predict_choosemodel_hlayout.addItem(spacerItem1)
        self.regression_predict_vlayout.addLayout(self.regression_choosemodel_hlayout)
