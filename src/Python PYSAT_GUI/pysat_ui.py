...
class pysat_ui(object):
    ...
    def files(self, MainWindow):
        ...
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.Files)
        ...
        self.horizontalLayout.addWidget(self.unknownDataButton)
        ...
        self.horizontalLayout_2.addWidget(self.fullDataBaseButton)
        ...
        self.horizontalLayout_3.addWidget(self.outPutLocationButton)
