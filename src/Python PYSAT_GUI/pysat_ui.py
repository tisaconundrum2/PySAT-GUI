...
class pysat_ui(object):
    ...
    def normalization(self, MainWindow):
        ...
        try:
            self.normalization_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.get_ranges(([(int(self.norm_spinBox_9.text()), int(self.norm_spinBox.text()))]))))
        except:
            pass
    ...
    def comp_ranges(self, MainWindow):
        ...
        try:
            self.compRanges_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.set_compranges([[int(self.comp_range.text()), int(self.comp_range_2.text())],
    ...
    def num_of_compoents(self, MainWindow):
        ...
        try:
            self.num_of_components_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.get_number_components([int(self.create_model_spin.text()),
    ...
    def y_variable(self, MainWindow):
        ...
        try:
            self.y_variable_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.set_element_name(self.elementNameLine.text())))
        except:
            pass
    ...
    def test_folds(self, MainWindow):
        ...
        self.verticalLayout_28 = QtGui.QVBoxLayout(self.Test_Folds)
        self.verticalLayout_28.setMargin(11)
        self.verticalLayout_28.setSpacing(6)
        self.verticalLayout_28.setObjectName(_fromUtf8("verticalLayout_28"))
        ...
        try:
            self.test_folds_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.set_testfold(int(self.test_fold_spinBox.text()))))
        except:
            pass
    ...
    def n_folds(self, MainWindow):
        ...
        try:
            self.test_folds_button.clicked.connect(lambda: self.list_of_functions.append(self.pysat_fun.set_nfolds(int(self.n_folds_spinBox.text()))))
        except:
            pass
    ...
    def masked(self, MainWindow):
        ...
        try:
            self.fullDataBaseButton_4.clicked.connect(lambda: self.list_of_functions.append(pysat_ui.on_maskFile_clicked(self, self.lineEdit_10)))
        except:
            pass
    ...
    def startified(self, MainWindow):
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.stratified.setFont(font)
        self.stratified.setObjectName(_fromUtf8("stratified"))
        self.verticalLayout_31 = QtGui.QVBoxLayout(self.stratified)
        self.verticalLayout_31.setMargin(11)
        ...
        self.verticalLayout_23.setSpacing(6)
        self.verticalLayout_23.setObjectName(_fromUtf8("verticalLayout_23"))
        self.label_16 = QtGui.QLabel(self.stratified)
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.verticalLayout_23.addWidget(self.label_16)
        self.horizontalLayout_12.addLayout(self.verticalLayout_23)
    ...
    def train_data(self, MainWindow):
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.train_unknown.setFont(font)
        self.train_unknown.setObjectName(_fromUtf8("train_unknown"))
        self.verticalLayout_32 = QtGui.QVBoxLayout(self.train_unknown)
        self.verticalLayout_32.setMargin(11)
        ...
        self.verticalLayout_23.setSpacing(6)
        self.verticalLayout_23.setObjectName(_fromUtf8("verticalLayout_23"))
        self.label_16 = QtGui.QLabel(self.train_unknown)
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.verticalLayout_23.addWidget(self.label_16)
        self.horizontalLayout_12.addLayout(self.verticalLayout_23)
        self.verticalLayout_32.addLayout(self.horizontalLayout_12)
        self.verticalLayout_8.addWidget(self.train_unknown)
        self.train_unknown.setTitle(_translate("MainWindow", "Train Unkown Data", None))
        self.label_16.setText(_translate("MainWindow", "Training unknown data", None))

        self.train_known = QtGui.QGroupBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.train_known.setFont(font)
        self.train_known.setObjectName(_fromUtf8("train_known"))
        self.verticalLayout_33 = QtGui.QVBoxLayout(self.train_known)
        self.verticalLayout_33.setMargin(11)
        ...
        self.verticalLayout_23.setSpacing(6)
        self.verticalLayout_23.setObjectName(_fromUtf8("verticalLayout_23"))
        self.label_16 = QtGui.QLabel(self.train_known)
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.verticalLayout_23.addWidget(self.label_16)
        self.horizontalLayout_12.addLayout(self.verticalLayout_23)
...
#### Opening Files
    ...
    def on_maskFile_clicked(self, lineEdit):
        ...
        self.list_of_functions.append(self.pysat_fun.set_file_maskfile(filename))
        if lineEdit.text() == "":
    ...
    def on_uknownDataButton_clicked(self, lineEdit):
        ...
        lineEdit.setText(filename)
        self.list_of_functions.append(self.pysat_fun.set_file_unknowndatacsv(filename))
        if lineEdit.text() == "":
            lineEdit.setText("*.csv")
    ...
    def on_fullDataBaseButton_clicked(self, lineEdit):
        filename = QFileDialog.getOpenFileName(None, "Open Uknown Data File", '.', "(*.csv)")
        lineEdit.setText(filename)
        self.list_of_functions.append(self.pysat_fun.set_file_knowndatacsv(filename))
        if lineEdit.text() == "":
            lineEdit.setText("*.csv")
        self.pysat_fun.get_spectra()
    ...
    def on_outPutLocationButton_clicked(self, lineEdit):
        ...
        lineEdit.setText(filename)
        self.list_of_functions.append(self.pysat_fun.set_file_outpath(filename))
        if lineEdit.text() == "":
            lineEdit.setText("*/*")
...
#### Ok Button Clicked
    ...
    def on_okButton_clicked(self):
        ...
        self.list_of_functions.append(self.pysat_fun.set_sm())
        self.list_of_functions.append(self.pysat_fun.get_sm_fit())
        self.list_of_functions.append(self.pysat_fun.get_plots())
