...
class pysat_ui(object):
    ...
    def mainframe(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 561, 791))
        font = QtGui.QFont()
        font.setPointSize(8)
...
#### UI modules
    ...
    def reference_data(self, MainWindow):
        ...
        self.reference_data_button = QtGui.QPushButton(self.referenceData)
        self.set_module_button(self.verticalLayout_15, self.reference_data_button)
